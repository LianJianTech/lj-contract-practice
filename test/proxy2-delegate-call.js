...
describe("Proxy", function () {
    it("", async function () {
        ...
        let result1 = await proxy2.delegateCallAddValue();
        console.log("proxy result1:", result1);
        let value1 = await biz3.getValue();
        console.log("biz3 delegateCallAddValue:", value1);

        await proxy2.setBizAddress(biz4.address);
        let result2 = await proxy2.delegateCallAddValue();
        console.log("proxy result2:", result2);
        let value2 = await biz4.getValue();
        console.log("biz4 delegateCallAddValue:", value2);
    });
});
