...
describe("Proxy", function () {
    it("", async function () {
        ...
        let result1 = await proxy.delegateCallAddValue();
        console.log("proxy result1:", result1);
        let value1 = await biz1.getValue();
        console.log("biz1 delegateCallAddValue:", value1);

        await proxy.setBizAddress(biz2.address);
        let result2 = await proxy.delegateCallAddValue();
        console.log("proxy result2:", result2);
        let value2 = await biz2.getValue();
        console.log("biz2 delegateCallAddValue:", value2);
    });
});
